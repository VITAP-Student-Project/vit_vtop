...
mixin _$GradeHistory {
 ...
 String get creditsRegistered; String get creditsEarned; String get cgpa;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GradeHistory&&(identical(other.creditsRegistered, creditsRegistered) || other.creditsRegistered == creditsRegistered)&&(identical(other.creditsEarned, creditsEarned) || other.creditsEarned == creditsEarned)&&(identical(other.cgpa, cgpa) || other.cgpa == cgpa));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,creditsRegistered,creditsEarned,cgpa);
...
/// Create a copy of GradeHistory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? creditsRegistered = null,Object? creditsEarned = null,Object? cgpa = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String creditsRegistered,  String creditsEarned,  String cgpa)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GradeHistory() when $default != null:
return $default(_that.creditsRegistered,_that.creditsEarned,_that.cgpa);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String creditsRegistered,  String creditsEarned,  String cgpa)  $default,) {final _that = this;
switch (_that) {
case _GradeHistory():
return $default(_that.creditsRegistered,_that.creditsEarned,_that.cgpa);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String creditsRegistered,  String creditsEarned,  String cgpa)?  $default,) {final _that = this;
switch (_that) {
case _GradeHistory() when $default != null:
return $default(_that.creditsRegistered,_that.creditsEarned,_that.cgpa);case _:
  return null;
...
class _GradeHistory implements GradeHistory {
  const _GradeHistory({required this.creditsRegistered, required this.creditsEarned, required this.cgpa});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GradeHistory&&(identical(other.creditsRegistered, creditsRegistered) || other.creditsRegistered == creditsRegistered)&&(identical(other.creditsEarned, creditsEarned) || other.creditsEarned == creditsEarned)&&(identical(other.cgpa, cgpa) || other.cgpa == cgpa));
}
...
/// Create a copy of GradeHistory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? creditsRegistered = null,Object? creditsEarned = null,Object? cgpa = null,}) {
