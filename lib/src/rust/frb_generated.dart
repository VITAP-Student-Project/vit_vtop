...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 254275630;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<HostelOutingData> crateApiVtopGetClientStudentOutingReport({
    required VtopClient client,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  crateApiVtopVtopClientVtopClientGetHostelLeaveReport({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta:
            kCrateApiVtopVtopClientVtopClientGetHostelLeaveReportConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiVtopGetClientLeaveReportConstMeta =>
      const TaskConstMeta(debugName: "leave_report", argNames: ["client"]);
  ...
  Future<HostelOutingData> crateApiVtopGetClientStudentOutingReport({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiVtopGetClientStudentOutingReportConstMeta,
        argValues: [client],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiVtopGetClientStudentOutingReportConstMeta =>
      const TaskConstMeta(
        debugName: "student_outing_report",
        argNames: ["client"],
      );
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_VtopResultGetFaculty =>
      wire.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVtopResultGetFaculty;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_VtopResultHostelOutingData =>
      wire.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVtopResultHostelOutingData;
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_VtopResultString =>
      wire.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVtopResultString;
  ...
  ComprehensiveDataResponse sse_decode_comprehensive_data_response(
    ...
    var var_examSchedule = sse_decode_list_per_exam_schedule_record(
      deserializer,
    );
    var var_gradeCourseHistory = sse_decode_list_grade_course_history(
      deserializer,
    );
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVtopResultHostelLeaveData(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as VtopResultHostelLeaveDataImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVtopResultHostelOutingData(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as VtopResultHostelOutingDataImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVtopResultHostelLeaveData(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as VtopResultHostelLeaveDataImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVtopResultHostelOutingData(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as VtopResultHostelOutingDataImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
...
class VtopClientImpl extends RustOpaque implements VtopClient {
  ...
  Future<VtopResultHostelLeaveData> getHostelLeaveReport() => RustLib
      .instance
      .api
      .crateApiVtopVtopClientVtopClientGetHostelLeaveReport(that: this);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib
            .instance
            .api
            .rust_arc_increment_strong_count_VtopResultHostelLeaveData,
    rustArcDecrementStrongCount:
        RustLib
            .instance
            .api
            .rust_arc_decrement_strong_count_VtopResultHostelLeaveData,
    rustArcDecrementStrongCountPtr:
        RustLib
            .instance
            .api
